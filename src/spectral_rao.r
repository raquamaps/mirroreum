...
## Latest update: 21th July 2016
## github link: https://github.com/mattmar/spectralrao/blob/master/spectralrao.r
## This code is a Supplementary material of the paper:
## Rocchini, D.*, Marcantonio, M.*, Ricotta, C. (2016). 
